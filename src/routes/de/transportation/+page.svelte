<div class="container">
	<h1>Transportführer für Lindau</h1>
	...
	<section>
		...
		<p>
			Der Hauptbahnhof in Lindau befindet sich auf der Insel und heißt Lindau-Insel. Er dient als Knotenpunkt für regionale und internationale Zugverbindungen.
		</p>

		<h4>Zugbetreiber</h4>
		<p>Zwei Hauptunternehmen betreiben Zugverbindungen ab Lindau-Insel:</p>
		<ul>
		...
		<ul>
			...
			<li>Oberstdorf</li>
			<li>Oberstaufen</li>
			<li>Füssen (für Schloss Neuschwanstein)</li>
			<li>Und mehr</li>
		</ul>
	...
	<section>
		...
		<div class="boat-schedule">
			<div class="schedule-card">
				<h3>09:25 - Rorschacher Bucht</h3>
				<p><strong>Abfahrt:</strong> Hafen Lindau</p>
				<p><strong>Häufigkeit:</strong> Täglich</p>
				<p><strong>Dauer:</strong> 2:15</p>
				<p><strong>Route:</strong> Rorschacher Bucht</p>
			</div>

			<div class="schedule-card">
				<h3>11:45 - Rorschacher Bucht</h3>
				<p><strong>Abfahrt:</strong> Hafen Lindau</p>
				<p><strong>Häufigkeit:</strong> Täglich</p>
				<p><strong>Dauer:</strong> 2:20</p>
				<p><strong>Route:</strong> Rorschacher Bucht</p>
			</div>

			<div class="schedule-card">
				<h3>12:00 - Panorama-Fahrt</h3>
				<p><strong>Abfahrt:</strong> Lindau Spielbank</p>
				<p><strong>Häufigkeit:</strong> Di-So & Feiertage</p>
				<p><strong>Dauer:</strong> 1:30</p>
				<p><strong>Route:</strong> Panorama-Fahrt</p>
			</div>

			<div class="schedule-card">
				<h3>14:00 - Panorama-Fahrt</h3>
				<p><strong>Abfahrt:</strong> Lindau Spielbank</p>
				<p><strong>Häufigkeit:</strong> Di-So & Feiertage</p>
				<p><strong>Dauer:</strong> 1:30</p>
				<p><strong>Route:</strong> Panorama-Fahrt</p>
			...
			<div class="schedule-card">
				<h3>14:45 - Drei-Länder-Rundfahrt</h3>
				<p><strong>Abfahrt:</strong> Hafen Lindau</p>
				<p><strong>Häufigkeit:</strong> Täglich</p>
				<p><strong>Dauer:</strong> 1:30</p>
				<p><strong>Route:</strong> Drei-Länder-Rundfahrt</p>
			</div>

			<div class="schedule-card">
				<h3>15:50 - Rorschacher Bucht</h3>
				<p><strong>Abfahrt:</strong> Hafen Lindau</p>
				<p><strong>Häufigkeit:</strong> Täglich</p>
				<p><strong>Dauer:</strong> 2:25</p>
				<p><strong>Route:</strong> Rorschacher Bucht</p>
			</div>

			<div class="schedule-card">
				<h3>16:00 - Bregenzer Bucht</h3>
				<p><strong>Abfahrt:</strong> Lindau Spielbank</p>
				<p><strong>Häufigkeit:</strong> Di-So & Feiertage</p>
				<p><strong>Dauer:</strong> 1:00</p>
				<p><strong>Route:</strong> Bregenzer Bucht</p>
			</div>

			<div class="schedule-card">
				<h3>18:05 - Abendstimmung Bregenz</h3>
				<p><strong>Abfahrt:</strong> Hafen Lindau</p>
				<p><strong>Häufigkeit:</strong> Täglich</p>
				<p><strong>Dauer:</strong> 0:52</p>
				<p><strong>Route:</strong> Abendstimmung Bregenz</p>
			</div>
		</div>

		<p>Routenbeschreibungen:</p>
		<ul>
			<li>
				<strong>Rorschacher Bucht:</strong> Eine Fahrt zur Schweizer Seite des Bodensees.
			</li>
			<li>
		...
		<ul>
			<li>Dieser Fahrplan gilt vom 18. Mai bis 8. September.</li>
			<li>
	...
	<section>
		...
		<div class="rental-shop">
			...
			<p><strong>Adresse:</strong> Inselgraben 14, Lindau</p>
			<p>
		...
		<div class="rental-shop">
			<h3>2. Rad Insel</h3>
			<p><strong>Adresse:</strong> Dammsteggasse 4, Lindau</p>
			<p>
				<strong>Website:</strong>
