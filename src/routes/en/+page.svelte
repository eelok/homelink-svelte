<div class="container">
	...
	<p>
		We're delighted you've chosen our apartment for your stay in Lindau. We hope you'll feel as
		comfortable here as we do and wish you a wonderful time at Lake Constance!
	</p>

	<h3>Quick Information</h3>
	<ul>
		<li>
			<strong>Keys:</strong> You have two keys - both have square ends. The apartment key is branded
			with ABUS.
		</li>
		<li>
			<strong>Location:</strong> Our apartment is on the second floor, right side. Please note there's
			no elevator.
		</li>
		<li>
			<strong>Wi-Fi:</strong> Network name: <strong>Martin</strong>. Access data is on the telephone
	...
	<ul>
		<li>
			...
			7 AM to 8 PM, closed on Sundays and holidays).
		</li>
		<li>
	...
	<p>
		We wish you an unforgettable stay in Lindau. If you have any questions, we're always available
		to help.
	</p>
