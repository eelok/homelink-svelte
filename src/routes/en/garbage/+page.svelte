<div class="container">
    ...
    <div class="row mt-2 border-bottom">
        <p>
            You can throw trash bags into the large bin in the courtyard. The trash bins are located in a locked room next to the basement. You can open this room with the front door key. There are bins for organic waste, residual waste, and paper.
            You can exceptionally throw plastic waste into the residual waste.
        </p>
    </div>
    <!--Organic Waste-->
    <div class="row mt-3">
    ...
    <div class="row">
        ...
        <h4 class="col">Residual Waste</h4>
    </div>
    <div class="row">
        <p>
    ...
    <div class="row">
        <h4 class="mb-2">Recycling Center</h4>
